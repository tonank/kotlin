...
<!ABSENCE_OF_PRIMARY_CONSTRUCTOR_FOR_INLINE_CLASS, INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>inline class A1<!>
inline class A2<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>()<!>
inline class A3(<!INLINE_CLASS_CONSTRUCTOR_NOT_READ_ONLY_PARAMETER!>x: Int<!>)
inline class A4(<!INLINE_CLASS_CONSTRUCTOR_NOT_READ_ONLY_PARAMETER!>var x: Int<!>)
inline class A5<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>(val x: Int, val y: Int)<!>
inline class A6<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>(<!INLINE_CLASS_CONSTRUCTOR_NOT_READ_ONLY_PARAMETER!>x: Int<!>, val y: Int)<!>
inline class A7(<!INLINE_CLASS_CONSTRUCTOR_NOT_READ_ONLY_PARAMETER!>vararg val x: Int<!>)
