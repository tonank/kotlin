...
public abstract class StackValue {
    ...
    protected void coerceTo(@NotNull Type toType, @Nullable KotlinType toKotlinType, @NotNull InstructionAdapter v) {
        if (coerceInlineClasses(this.type, this.kotlinType, toType, toKotlinType, v)) return;
    ...
    protected void coerceFrom(@NotNull Type topOfStackType, @Nullable KotlinType topOfStackKotlinType, @NotNull InstructionAdapter v) {
        if (coerceInlineClasses(topOfStackType, topOfStackKotlinType, this.type, this.kotlinType, v)) return;
    ...
    private static boolean coerceInlineClasses(
        ...
        boolean isFromTypeUnboxed = isUnboxed(fromKotlinType, fromType);
        if (InlineClassesUtilsKt.isInlineClassType(toKotlinType)) {
            boolean isToTypeUnboxed = isUnboxed(toKotlinType, toType);
    ...
    private static boolean isUnboxed(@NotNull KotlinType kotlinType, @NotNull Type actualType) {
