...
public class FunctionCodegen {
    ...
    public void generateMethod(
        ...
        boolean isMethodInValueClassWrapper =
        ...
        else if (isMethodInValueClassWrapper) {
    ...
    private void generateMethodInsideInlineClassWrapper(
        ...
        ValueParameterDescriptor valueRepresentation = InlineClassesUtilsKt.underlyingRepresentationForInlineClass(containingDeclaration);
