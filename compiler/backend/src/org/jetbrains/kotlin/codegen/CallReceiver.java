...
public class CallReceiver extends StackValue {
    ...
    public static StackValue generateCallReceiver(
        ...
        if (extensionReceiverParameter != null) {
            AsmTypeAndKotlinType extensionReceiverInfo = calcExtensionReceiverType(
                    resolvedCall, extensionReceiverParameter, typeMapper, callableMethod, state
            );
            type = extensionReceiverInfo.getType();
            kotlinType = extensionReceiverInfo.getKotlinType();
            ...
            AsmTypeAndKotlinType asmTypeAndKotlinType = calcDispatchReceiverType(resolvedCall, dispatchReceiverParameter, typeMapper, callableMethod);
            type = asmTypeAndKotlinType.getType();
            kotlinType = asmTypeAndKotlinType.getKotlinType();
        }
        ...
        return new CallReceiver(dispatchReceiver, extensionReceiver, type, kotlinType, secondReceiverType, secondReceiverKotlinType);
    }
